		...
		<div class="container">
			...
			<div class="main-page">
				...
				<div class="description">
					...
					<p>Представленные службы должны выполнять такие задачи: Контролировать обслуживаемые объекты для своевременного выявления поломок или неисправностей. Быстро реагировать на обращение граждан. То есть ремонтная бригада должна немедленно выехать на вызов, обнаружить причину поломки и устранить ее. Выполнять свои обязанности по спасению жизни и здоровья человека, его имущества, а также ликвидации чрезвычайных ситуаций и их последствий.</p>
				</div>
