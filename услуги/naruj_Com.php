	...
	<div class="banner">
		<div class="container">
			...
			<div class="description">
					<h1>Наружные коммуникации</h1>
					<p>Наружные инженерные коммуникации — это то, без чего не обходится строительство. Любое здание просто не удастся сдать в эксплуатацию без грамотно налаженной сети наружных коммуникаций. Говоря проще, это все то, что необходимо для поддержания жизнедеятельности</p>
				</div>
