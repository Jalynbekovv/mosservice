	...
	<div class="banner">
		<div class="container">
			...
			<div class="description">
					<h1>Наружные инженерные сети</h1>

					<p>Наружные инженерные сети представляют собой комплекс коммуникаций, находящихся снаружи зданий и объектов. Например, линии электропередач, гидротехнические сооружения, газопроводы, очистительные станции, системы заземления, спутниковые антенны и другие</p>
				</div>
