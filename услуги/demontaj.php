	...
	<div class="banner">
		<div class="container">
			...
			<div class="description">
					<h1>Демонтажные услуги</h1>

					<p>Демонтажные работы проводятся для того чтобы освободить помещение от мусора, перегородок и других элементов в которых не нуждается дальнейшее использование. Зачастую такие работы необходимы при ремонте помещений, например, как при демонтаже гипсокартонных стен и т.д. Но не всегда есть возможность провести такие работы по техническим причинам, или для дальнейшего использования, поэтому демонтажные работы необходимы</p>
				</div>
