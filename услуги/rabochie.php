	...
	<div class="banner">
		<div class="container">
			...
			<div class="description">
					<h1>Подсобные рабочие</h1>

					<p>В строительном мире есть два понятия — разнорабочий и подсобные рабочие. Часто понятия смешиваются, однако между ними существует одно большое различие – наличие образования. Разнорабочий – это человек, который просто занимается разнообразным физическим трудом, так называемой «черной работой», в то время как подсобным рабочих называют людей с определённой строительной профессией, которые не имеют опыта и работают со старшим товарищем – мастером</p>
				</div>
