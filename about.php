...
<html>
<head>
	<title>Heavy Industry a Industrial Category Flat Bootstrap Responsive Website Template | About :: w3layouts</title>
<!--fonts-->
	...
	<div class="container">
		...
		<div class="top-left">
					<ul>
						...
						<li><a href="machinery.php">Услуги</a></li>
						<li><a href="machinery.php">Галерея</a></li>
				...
				<div class="top-right">
					<ul>
						...
						<li><a href="index.php" style="color: white;">khangeldi@gmail.com</a></li>
						<li><a href="https://wa.me/+79260460002" style="color: white;" >+7(926)046-00-02</a></li>
					</ul>
				</div>
...
<div class="camps">
	<div class="container">
		<h3 class="tittle mid">TOP INDUSTRIES</h3>
			<div class="cam-top-top">
				<div class="col-md-7 cam-top">
					<iframe src="https://www.youtube.com/embed/dkpEKS8NztE"></iframe>
				</div>
